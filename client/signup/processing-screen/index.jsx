...
module.exports = React.createClass( {
	...
	getTitle: function() {
		...
		if ( stepWithDomainItem ) {
			...
			return loginHandler
				? this.translate( "{{strong}}Done!{{/strong}} Thanks for waiting, %(domain)s is all set up and we're ready " +
					'for you to get started.', {
						components: { strong: <strong /> },
						args: { domain }
					}
				)
				: this.translate( '{{strong}}Awesome!{{/strong}} Give us one minute while we set up %(domain)s for you.', {
					components: { strong: <strong /> },
					args: { domain }
				} );
		}
		...
		return loginHandler
			? this.translate( '{{strong}}Done!{{/strong}} Thanks for waiting, we’re ready for you to get started.', {
				components: { strong: <strong /> }
			} )
			: this.translate( '{{strong}}Awesome!{{/strong}} Give us one minute and we’ll move right along.', {
				components: { strong: <strong /> }
			} );
	},
